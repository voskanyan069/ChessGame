...
ChessServer::Stub::Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel)
  ...
  , rpcmethod_GetViewersCount_(ChessServer_method_names[6], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_GetUsername_(ChessServer_method_names[7], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_WaitForReady_(ChessServer_method_names[8], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_Ready_(ChessServer_method_names[9], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_MovePiece_(ChessServer_method_names[10], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_ReadPieceMove_(ChessServer_method_names[11], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_SetKingHittable_(ChessServer_method_names[12], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  {}
